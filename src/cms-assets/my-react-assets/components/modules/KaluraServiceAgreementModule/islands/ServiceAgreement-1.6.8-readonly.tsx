// Kalura Service Agreement module v1.6.8-readonly
      ...
      <div className={styles.majorSection}>
        ...
        <table className={styles.supportsTable}>
          ...
          <tbody>
            ...
            <tr>
              <td><TextInput value={supportItem4} onChange={setSupportItem4} /></td>
              <td><TextArea value={supportDescription4} onChange={setSupportDescription4} rows={3} /></td>
              <td><TextArea value={supportPrice4} onChange={setSupportPrice4} rows={3} /></td>
              <td><TextArea value={supportDelivery4} onChange={setSupportDelivery4} rows={3} /></td>
            </tr>

            <tr>
              <td><TextInput value={supportItem5} onChange={setSupportItem5} /></td>
              <td><TextArea value={supportDescription5} onChange={setSupportDescription5} rows={3} /></td>
              <td><TextArea value={supportPrice5} onChange={setSupportPrice5} rows={3} /></td>
              <td><TextArea value={supportDelivery5} onChange={setSupportDelivery5} rows={3} /></td>
            </tr>

            <tr>
              <td><TextInput value={supportItem6} onChange={setSupportItem6} /></td>
              <td><TextArea value={supportDescription6} onChange={setSupportDescription6} rows={3} /></td>
              <td><TextArea value={supportPrice6} onChange={setSupportPrice6} rows={3} /></td>
              <td><TextArea value={supportDelivery6} onChange={setSupportDelivery6} rows={3} /></td>
            </tr>
          </tbody>
        </table>
