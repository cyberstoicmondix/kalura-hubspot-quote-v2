// Kalura Service Agreement module v1.7.0 — 7-column schedule table
...
interface SupportScheduleRow {
  supportItemNameAndNumber: string;
  supportItemDescription: string;
  serviceDayTimeAndLocation: string;
...
export default function ServiceAgreement({
  ...
  const [supportScheduleRows, setSupportScheduleRows] = useState<SupportScheduleRow[]>([
    { supportItemNameAndNumber: supportItem1Prop || "", supportItemDescription: supportDescription1Prop || "", serviceDayTimeAndLocation: "", frequencyServiceArrangement: supportDelivery1Prop || "", pricePerHour: supportPrice1Prop || "", quantity: "", totalPrice: "" },
    { supportItemNameAndNumber: supportItem2Prop || "", supportItemDescription: supportDescription2Prop || "", serviceDayTimeAndLocation: "", frequencyServiceArrangement: supportDelivery2Prop || "", pricePerHour: supportPrice2Prop || "", quantity: "", totalPrice: "" },
    { supportItemNameAndNumber: supportItem3Prop || "", supportItemDescription: supportDescription3Prop || "", serviceDayTimeAndLocation: "", frequencyServiceArrangement: supportDelivery3Prop || "", pricePerHour: supportPrice3Prop || "", quantity: "", totalPrice: "" },
    { supportItemNameAndNumber: "", supportItemDescription: "", serviceDayTimeAndLocation: "", frequencyServiceArrangement: "", pricePerHour: "", quantity: "", totalPrice: "" },
    { supportItemNameAndNumber: "", supportItemDescription: "", serviceDayTimeAndLocation: "", frequencyServiceArrangement: "", pricePerHour: "", quantity: "", totalPrice: "" },
    { supportItemNameAndNumber: "", supportItemDescription: "", serviceDayTimeAndLocation: "", frequencyServiceArrangement: "", pricePerHour: "", quantity: "", totalPrice: "" },
  ]);
  ...
  const normalizeScheduleRows = (value: unknown): SupportScheduleRow[] => {
    if (!Array.isArray(value)) return [];

    const read = (obj: Record<string, unknown>, key: string): string => {
      const found = Object.entries(obj).find(([storedKey]) => storedKey.toLowerCase() === key.toLowerCase());
      return found ? String(found[1] ?? "") : "";
    };

    return value.slice(0, 6).map((row) => {
      const obj = row && typeof row === "object" ? row as Record<string, unknown> : {};
      // Accept both the new 7-column format and the previous 9-column format.
      const oldName = [read(obj, "supportItemName"), read(obj, "supportItemNumber")].filter(Boolean).join(" ");
      const oldService = [read(obj, "serviceDayAndTime"), read(obj, "location")].filter(Boolean).join(" | ");
      return {
        supportItemNameAndNumber: read(obj, "supportItemNameAndNumber") || oldName,
        supportItemDescription: read(obj, "supportItemDescription"),
        serviceDayTimeAndLocation: read(obj, "serviceDayTimeAndLocation") || oldService,
        frequencyServiceArrangement: read(obj, "frequencyServiceArrangement"),
        pricePerHour: read(obj, "pricePerHour") || read(obj, "pricePerHourOrUnit"),
        quantity: read(obj, "quantity"),
        totalPrice: read(obj, "totalPrice"),
      };
    });
  };
  ...
  useEffect(() => {
    ...
    async function loadAgreement() {
      try {
        ...
        const savedSupportRows = normalizeScheduleRows(getSavedValue<unknown>(data, "supportScheduleRows", null));
        if (savedSupportRows.length > 0) {
          while (savedSupportRows.length < 6) {
            savedSupportRows.push({ supportItemNameAndNumber: "", supportItemDescription: "", serviceDayTimeAndLocation: "", frequencyServiceArrangement: "", pricePerHour: "", quantity: "", totalPrice: "" });
          }
          setSupportScheduleRows(savedSupportRows);
        }
  ...
  return (
    <div className={styles.document}>
      ...
      <div className={styles.majorSection}>
        ...
        {/* Seven-column schedule table; exactly six editable rows. */}
        <table
            ...
            {supportScheduleRows.map((row, rowIndex) => (
              <tr key={rowIndex} style={{ height: "98px" }}>
                <td style={{ padding: "3px", verticalAlign: "top" }}>
                  <TextArea
                    value={row.supportItemNameAndNumber}
                    onChange={(value) => updateSupportScheduleCell(rowIndex, "supportItemNameAndNumber", value)}
                    rows={4}
                  />
                </td>
                <td style={{ padding: "3px", verticalAlign: "top" }}>
                ...
                <td style={{ padding: "3px", verticalAlign: "top" }}>
                  <TextArea
                    value={row.serviceDayTimeAndLocation}
                    onChange={(value) => updateSupportScheduleCell(rowIndex, "serviceDayTimeAndLocation", value)}
                    rows={4}
                  />
                </td>
                <td style={{ padding: "3px", verticalAlign: "top" }}>
                ...
                <td style={{ padding: "3px", verticalAlign: "top" }}>
                  <TextInput
                    ...
                    onChange={(value) => updateSupportScheduleCell(rowIndex, "pricePerHour", value)}
                  />
                </td>
                <td style={{ padding: "3px", verticalAlign: "top" }}>
                  <TextInput
