  ...
  return (
    <div className={styles.document}>
      ...
      {isInEditor && (
        ...
        >
          <strong>Editor mode:</strong> Sections 1–23 and 25 are edited using the
          HubSpot module fields in the quote editor. Those field values are the
          persistent source of truth and are rendered in this agreement. The
          fields shown inside the document are intentionally non-interactive to
          prevent edits that HubSpot cannot persist. Section 24 is participant-controlled.
        </div>
      )}
      ...
      <fieldset
        ...
        style={{
          ...
          margin: 0,
          minWidth: 0,
          pointerEvents: isInEditor ? "none" : undefined,
        }}
