// Kalura Service Agreement module v1.6.9 — 9-column schedule table
...
export default function ServiceAgreement({
  ...
  const [supportScheduleRows, setSupportScheduleRows] = useState<SupportScheduleRow[]>([
    {
      supportItemName: supportItem1Prop || "",
      supportItemNumber: "",
      supportItemDescription: supportDescription1Prop || "",
      serviceDayAndTime: "",
      frequencyServiceArrangement: supportDelivery1Prop || "",
      location: "",
      pricePerHourOrUnit: supportPrice1Prop || "",
      quantity: "",
      totalPrice: "",
    },
    {
      supportItemName: supportItem2Prop || "",
      supportItemNumber: "",
      supportItemDescription: supportDescription2Prop || "",
      serviceDayAndTime: "",
      frequencyServiceArrangement: supportDelivery2Prop || "",
      location: "",
      pricePerHourOrUnit: supportPrice2Prop || "",
      quantity: "",
      totalPrice: "",
    },
    {
      supportItemName: supportItem3Prop || "",
      supportItemNumber: "",
      supportItemDescription: supportDescription3Prop || "",
      serviceDayAndTime: "",
      frequencyServiceArrangement: supportDelivery3Prop || "",
      location: "",
      pricePerHourOrUnit: supportPrice3Prop || "",
      quantity: "",
      totalPrice: "",
    },
    { supportItemName: "", supportItemNumber: "", supportItemDescription: "", serviceDayAndTime: "", frequencyServiceArrangement: "", location: "", pricePerHourOrUnit: "", quantity: "", totalPrice: "" },
    { supportItemName: "", supportItemNumber: "", supportItemDescription: "", serviceDayAndTime: "", frequencyServiceArrangement: "", location: "", pricePerHourOrUnit: "", quantity: "", totalPrice: "" },
    { supportItemName: "", supportItemNumber: "", supportItemDescription: "", serviceDayAndTime: "", frequencyServiceArrangement: "", location: "", pricePerHourOrUnit: "", quantity: "", totalPrice: "" },
  ]);
              ...
              <tr key={rowIndex} style={{ height: "58px" }}>
                ...
                <td style={{ padding: "3px", verticalAlign: "top" }}>
                  <TextInput
                    value={row.location}
                    onChange={(value) =>
                      updateSupportScheduleCell(rowIndex, "location", value)
                    }
                  />
                </td>
                <td style={{ padding: "3px", verticalAlign: "top" }}>
                ...
                <td style={{ padding: "3px", verticalAlign: "top" }}>
                  <TextInput
                    value={row.quantity}
                    onChange={(value) =>
                      updateSupportScheduleCell(rowIndex, "quantity", value)
                    }
                  />
                </td>
                <td style={{ padding: "3px", verticalAlign: "top" }}>
                  <TextInput
                    ...
                    onChange={(value) =>
                      updateSupportScheduleCell(rowIndex, "totalPrice", value)
                    }
                  />
                </td>
              </tr>
